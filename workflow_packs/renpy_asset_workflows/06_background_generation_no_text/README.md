...
- `workflow_api/06_background_generation_no_text_api.json` — minimal-smoke no-text classroom background baseline; also day/night base-generation route | inputs: - | status: SMOKE PASS: ilV180 minimal txt2img; use separate 06 generations for day/night; RenPy textbox QA still required
